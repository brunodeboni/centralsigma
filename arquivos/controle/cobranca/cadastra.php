...
<body>
	<div>
		<h1>Cadastro de cobranças</h1>
			<table>
				<tr class="firstline"><td><a href="cadastra_conta.php">Cadastro de Contas a Receber</a></td></tr>
				<tr class="secondline"><td><a href="cadastra_postagem.php">Cadastro de Postagem de Cobrança</a></td></tr>
				<tr class="firstline"><td><a href="cadastra_pagto.php">Cadastro de Pagamento de Cobrança</a></td></tr>
			</table>
			<div>
