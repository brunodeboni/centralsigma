...
$updateQuery = "update 1yAM4n2bIFsOfv70zz6E4fRq6yvf_WFmFw2vEhM0 set Nome = '".$nome."', Endereco = '".$endereco."', Facebook = '".$facebook."', LinkedIn = '".$linkedin."', Empresa = '".$empresa."' where rowid = '".$rowid."'";
