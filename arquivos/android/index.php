...
<head>
	<meta charset="utf-8">
	<title>Lançamento SIGMA Android</title>
...
<div id="container">
	<div>
		...
		<p>Aplicativos desenvolvidos em JAVA para uso em tablets e smartphones, no sistema operacional mais popular do mundo para estes aparelhos. O sistema ANDROID, desenvolvido pelo Google.</p>
		...
		<h2>INSCREVA-SE PARA RECEBER TABLETs E SMARTPHONES</h2>         
		<p>A Rede Industrial realizará seleção entre as empresas usuárias do SIGMA para fornecer gratuitamente smartphones e tablets.  Para inscrever a sua empresa nesta seleção, clique aqui.</p>

		<h2>Cronograma dos lançamentos</h2>
   		<h3>Versão 1.0  Data de lançamento 01/08/2013</h3>
        	<p>SS – Solicitação de serviços MOBILE -  Abertura e consulta de solicitações de serviço.</p>
   		<h3>Versão 2.0  Data de lançamento 01/10/2013</h3>
        	<p>OS – Ordens de serviço - Abertura de ordens de serviço para manutenção corretiva.</p>
   		<h3>Versão 3.0  Data de lançamento 01/12/2013</h3>
         	<p>HH – Homem hora -  lançamento de horas trabalhadas.</p>
   		<h3>Versão 4.0  Data de lançamento 01/03/2014</h3>
        	<p>Programações de manutenção preventiva.</p> 
  		<h3>Versão 5.0  Data de lançamento 01/06/2014</h3>
        	<p>Relatórios e gráficos gerenciais e indicadores de manutenção.</p>
        
        <p><i>As empresas inscritas e selecionadas receberão gratuitamente os equipamentos e todas as versões agendadas.</i></p>

		<h2>A VISÃO DA REDE INDUSTRIAL</h2>
		<p>“O desenvolvimento do SIGMA Android foi inciado para atender a demanda crescente do uso da mobilidade na gestão de negócios e processos, por meio da popularização dos smartphones e tablets dentro das organizações.” ressalta Carolina Luz, gerente comercial da Rede Industrial. Estamos investindo na criação de tecnologias de ponta, para nos tornarmos, cada vez mais, através do SIGMA, um parceiro tecnológico estratégico para nossos clientes, que demandam continuamente a oferta de novas soluções que contribuam para melhoria efetiva em seus processos operacionais e de gestão”</p>
	
	</div>
	<div id="div_form">
		<h1>Preencha os dados e participe da nossa seleção!</h1>
		<form action="" method="post" id="form_promo">
			<span>Nome:</span>
