<?
	...
	if($_REQUEST['funcao'] == 'updateprogramacao')
	{
		...
		if($_REQUEST['status'] == '')
		{
			...
			$sql = "update SMS SET  mensagem='$mensagem',tipo_prog='$tipo_prog' where codigo_prog = '$codigo_prog' and codigo_cliente = '$codigo_cliente'  ";
		}
		else
			{
	...
	{
		echo '12/31/2014';//echo date('m/d/2014 h:i');//, strtotime($row['CSMS_DTHR_TERMINO']));
	}
