<?
	...
	if($_REQUEST['funcao'] == 'updateprogramacao')
	{
		...
		$status_envio = $_REQUEST['status_envio'];
		
		  $sql = "update vsms_documento set tipo_prog='$tipo_prog' where codigo_cliente = '$codigo_cliente'";
	...
	if($_REQUEST['funcao'] == 'registrahistoricodc')
	{
		...
		while ($row = mysql_fetch_assoc($res2)) { 			
			...
			echo $qr4 = " SELECT COUNT(HISTC_ID) AS TOTAL 
				FROM
				HISTORICO_CLIENTE 
			...
			if($total == '0')
			{
				echo $query5 = "INSERT INTO HISTORICO_CLIENTE 
